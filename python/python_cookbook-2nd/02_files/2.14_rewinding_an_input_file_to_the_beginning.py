...
class RewindableFile(object):
    ...
    def seek(self, offset, whence=0):
        ...
        if offset != self.start:
            raise ValueError("offset=%r; excpecting %s" % (offset, self.start))
        self.rewind()
    ...
    def tell(self):
        ...
        if not self.at_start:
            raise TypeError("RewinableFile can't tell except at start of file")
        return self.start
    ...
    def _read(self, size):
        if size < 0:  # read all the way to the end of the file
            ...
            print "buffer_file", self.buffer_file.read()
...
infile = urllib2.urlopen("http://www.baidu.com")
